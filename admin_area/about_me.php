            ...
            <div data-aos="flip-left" class="row justify-content-center mt-5">
                <div class="col-md-6">
                    <div class="card shadow bg-blue">
                        <div class="card-body">
                            <h2 class="cookie-regular text-center text-color-yellow">Tell Us About Yourself</h2>
                            <h1 class="acme-regular text-center text-color-green">Personal Information</h1>
                            <form method="post">
                                <div class="mb-3">
                                    <label class="form-label">Tell us about yourself</label>
                                    <textarea class="form-control" rows="5" placeholder="Write something about yourself" name="intro"required></textarea>
                                </div>
                                <div class="text-center">
                                    <button type="submit" class="btn bg-yellow w-50 text-white" name="submit">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
